...
exports.errors = exports.mongo = exports.consortium = void 0;
const config_1 = require("./config");
//Applications
exports.consortium = {
    initialised: (port) => `${config_1.application.name} API server listening on port => ${port}`,
    welcome: `${config_1.application.name} Mainframe API`
};
// MongoDB
exports.mongo = {
    error: (error) => `MongoDB connection error. ${error}`,
    success: (dbURL, dbName, port) => `MongoDB connected succesfully. Host: ${dbURL}, Database: ${dbName},Port: ${port}`,
};
exports.errors = {
    // Common
